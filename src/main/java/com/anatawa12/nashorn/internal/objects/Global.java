...
import static com.anatawa12.nashorn.internal.lookup.Lookup.MH;
import static com.anatawa12.nashorn.internal.runtime.ECMAErrors.referenceError;
import static com.anatawa12.nashorn.internal.runtime.ECMAErrors.typeError;
import static com.anatawa12.nashorn.internal.runtime.JSType.isString;
import static com.anatawa12.nashorn.internal.runtime.ScriptRuntime.UNDEFINED;
...
import com.anatawa12.nashorn.api.scripting.ClassFilter;
import com.anatawa12.nashorn.api.scripting.ScriptObjectMirror;
import com.anatawa12.nashorn.internal.lookup.Lookup;
import com.anatawa12.nashorn.internal.objects.annotations.Attribute;
import com.anatawa12.nashorn.internal.objects.annotations.Getter;
...
import com.anatawa12.nashorn.internal.objects.annotations.Setter;
import com.anatawa12.nashorn.internal.runtime.Context;
import com.anatawa12.nashorn.internal.runtime.ECMAErrors;
import com.anatawa12.nashorn.internal.runtime.FindProperty;
import com.anatawa12.nashorn.internal.runtime.GlobalConstants;
import com.anatawa12.nashorn.internal.runtime.GlobalFunctions;
import com.anatawa12.nashorn.internal.runtime.JSType;
import com.anatawa12.nashorn.internal.runtime.NativeJavaPackage;
import com.anatawa12.nashorn.internal.runtime.PropertyDescriptor;
...
import com.anatawa12.nashorn.internal.runtime.Specialization;
import com.anatawa12.nashorn.internal.runtime.Symbol;
import com.anatawa12.nashorn.internal.runtime.arrays.ArrayData;
import com.anatawa12.nashorn.internal.runtime.linker.Bootstrap;
import com.anatawa12.nashorn.internal.runtime.linker.InvokeByName;
import com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor;
import com.anatawa12.nashorn.internal.runtime.regexp.RegExpResult;
import com.anatawa12.nashorn.internal.scripts.JD;
import com.anatawa12.nashorn.internal.scripts.JO;
import com.anatawa12.nashorn.tools.ShellFunctions;
...
public final class Global extends Scope {
    ...
    private static final String PACKAGE_PREFIX = "com.anatawa12.nashorn.internal.objects.";
    ...
    @Override
    public void addBoundProperties(final ScriptObject source, final com.anatawa12.nashorn.internal.runtime.Property[] properties) {
        ...
        if (context.getEnv()._es6) {
            ...
            for (final com.anatawa12.nashorn.internal.runtime.Property property : properties) {
                if (property.isLexicalBinding()) {
                    hasLexicalDefinitions = true;
                }
                // ES6 15.1.8 steps 6. and 7.
                final com.anatawa12.nashorn.internal.runtime.Property globalProperty = ownMap.findProperty(property.getKey());
                ...
                final com.anatawa12.nashorn.internal.runtime.Property lexicalProperty = lexicalMap.findProperty(property.getKey());
    ...
    private List<com.anatawa12.nashorn.internal.runtime.Property> extractBuiltinProperties(final String name, final ScriptObject func) {
        final List<com.anatawa12.nashorn.internal.runtime.Property> list = new ArrayList<>();
        ...
        final com.anatawa12.nashorn.internal.runtime.Property prop = getProperty(name);
        if (prop != null) {
            list.add(prop);
        }
    ...
    private void tagBuiltinProperties(final String name, final ScriptObject func) {
        ...
        for (final com.anatawa12.nashorn.internal.runtime.Property prop : extractBuiltinProperties(name, func)) {
    ...
    private void initFunctionAndObject() {
        ...
        com.anatawa12.nashorn.internal.runtime.Property[] properties = getFunctionPrototype().getMap().getProperties();
        for (final com.anatawa12.nashorn.internal.runtime.Property property : properties) {
        ...
        for (final com.anatawa12.nashorn.internal.runtime.Property property : builtinObject.getMap().getProperties()) {
            final Object key = property.getKey();
    ...
    private static class LexicalScope extends ScriptObject {
        ...
        @Override
        protected PropertyMap addBoundProperty(final PropertyMap propMap, final ScriptObject source, final com.anatawa12.nashorn.internal.runtime.Property property, final boolean extensible) {
