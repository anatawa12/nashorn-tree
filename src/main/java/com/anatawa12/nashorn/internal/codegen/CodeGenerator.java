...
import static com.anatawa12.nashorn.internal.codegen.ClassEmitter.Flag.PRIVATE;
import static com.anatawa12.nashorn.internal.codegen.ClassEmitter.Flag.STATIC;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.ARGUMENTS;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.CALLEE;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.CREATE_PROGRAM_FUNCTION;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.GET_MAP;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.GET_STRING;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.QUICK_PREFIX;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.REGEX_PREFIX;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.SCOPE;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.SPLIT_PREFIX;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.THIS;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.VARARGS;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.interfaceCallNoLookup;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.methodDescriptor;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.staticCallNoLookup;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.typeDescriptor;
import static com.anatawa12.nashorn.internal.codegen.CompilerConstants.virtualCallNoLookup;
import static com.anatawa12.nashorn.internal.ir.Symbol.HAS_SLOT;
import static com.anatawa12.nashorn.internal.ir.Symbol.IS_INTERNAL;
import static com.anatawa12.nashorn.internal.runtime.UnwarrantedOptimismException.INVALID_PROGRAM_POINT;
import static com.anatawa12.nashorn.internal.runtime.UnwarrantedOptimismException.isValid;
import static com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_APPLY_TO_CALL;
import static com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_DECLARE;
import static com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_FAST_SCOPE;
import static com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_OPTIMISTIC;
import static com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_PROGRAM_POINT_SHIFT;
import static com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_SCOPE;
...
import com.anatawa12.nashorn.internal.AssertsEnabled;
import com.anatawa12.nashorn.internal.IntDeque;
import com.anatawa12.nashorn.internal.codegen.ClassEmitter.Flag;
import com.anatawa12.nashorn.internal.codegen.CompilerConstants.Call;
import com.anatawa12.nashorn.internal.codegen.types.ArrayType;
import com.anatawa12.nashorn.internal.codegen.types.Type;
import com.anatawa12.nashorn.internal.ir.AccessNode;
import com.anatawa12.nashorn.internal.ir.BaseNode;
import com.anatawa12.nashorn.internal.ir.BinaryNode;
import com.anatawa12.nashorn.internal.ir.Block;
import com.anatawa12.nashorn.internal.ir.BlockStatement;
import com.anatawa12.nashorn.internal.ir.BreakNode;
import com.anatawa12.nashorn.internal.ir.CallNode;
import com.anatawa12.nashorn.internal.ir.CaseNode;
import com.anatawa12.nashorn.internal.ir.CatchNode;
import com.anatawa12.nashorn.internal.ir.ContinueNode;
import com.anatawa12.nashorn.internal.ir.EmptyNode;
import com.anatawa12.nashorn.internal.ir.Expression;
import com.anatawa12.nashorn.internal.ir.ExpressionStatement;
import com.anatawa12.nashorn.internal.ir.ForNode;
import com.anatawa12.nashorn.internal.ir.FunctionNode;
import com.anatawa12.nashorn.internal.ir.GetSplitState;
import com.anatawa12.nashorn.internal.ir.IdentNode;
import com.anatawa12.nashorn.internal.ir.IfNode;
import com.anatawa12.nashorn.internal.ir.IndexNode;
import com.anatawa12.nashorn.internal.ir.JoinPredecessorExpression;
import com.anatawa12.nashorn.internal.ir.JumpStatement;
import com.anatawa12.nashorn.internal.ir.JumpToInlinedFinally;
import com.anatawa12.nashorn.internal.ir.LabelNode;
import com.anatawa12.nashorn.internal.ir.LexicalContext;
import com.anatawa12.nashorn.internal.ir.LexicalContextNode;
import com.anatawa12.nashorn.internal.ir.LiteralNode;
import com.anatawa12.nashorn.internal.ir.LiteralNode.ArrayLiteralNode;
import com.anatawa12.nashorn.internal.ir.LiteralNode.PrimitiveLiteralNode;
import com.anatawa12.nashorn.internal.ir.LocalVariableConversion;
import com.anatawa12.nashorn.internal.ir.LoopNode;
import com.anatawa12.nashorn.internal.ir.Node;
import com.anatawa12.nashorn.internal.ir.ObjectNode;
import com.anatawa12.nashorn.internal.ir.Optimistic;
import com.anatawa12.nashorn.internal.ir.PropertyNode;
import com.anatawa12.nashorn.internal.ir.ReturnNode;
import com.anatawa12.nashorn.internal.ir.RuntimeNode;
import com.anatawa12.nashorn.internal.ir.RuntimeNode.Request;
import com.anatawa12.nashorn.internal.ir.SetSplitState;
import com.anatawa12.nashorn.internal.ir.SplitReturn;
import com.anatawa12.nashorn.internal.ir.Splittable;
import com.anatawa12.nashorn.internal.ir.Statement;
import com.anatawa12.nashorn.internal.ir.SwitchNode;
import com.anatawa12.nashorn.internal.ir.Symbol;
import com.anatawa12.nashorn.internal.ir.TernaryNode;
import com.anatawa12.nashorn.internal.ir.ThrowNode;
import com.anatawa12.nashorn.internal.ir.TryNode;
import com.anatawa12.nashorn.internal.ir.UnaryNode;
...
import com.anatawa12.nashorn.internal.ir.visitor.NodeOperatorVisitor;
import com.anatawa12.nashorn.internal.ir.visitor.SimpleNodeVisitor;
import com.anatawa12.nashorn.internal.objects.Global;
import com.anatawa12.nashorn.internal.parser.Lexer.RegexToken;
...
import com.anatawa12.nashorn.internal.runtime.ECMAException;
import com.anatawa12.nashorn.internal.runtime.JSType;
import com.anatawa12.nashorn.internal.runtime.OptimisticReturnFilters;
...
import com.anatawa12.nashorn.internal.runtime.RewriteException;
import com.anatawa12.nashorn.internal.runtime.Scope;
...
import com.anatawa12.nashorn.internal.runtime.UnwarrantedOptimismException;
import com.anatawa12.nashorn.internal.runtime.arrays.ArrayData;
import com.anatawa12.nashorn.internal.runtime.linker.LinkerCallSite;
import com.anatawa12.nashorn.internal.runtime.linker.NashornCallSiteDescriptor;
...
final class CodeGenerator extends NodeOperatorVisitor<CodeGeneratorLexicalContext> implements Loggable {
    ...
    private MethodEmitter globalAllocateArray(final ArrayType type) {
        ...
        return method.invokestatic(GLOBAL_OBJECT, "allocate", "(" + type.getDescriptor() + ")Lcom.anatawa12.nashorn/internal/objects/NativeArray;");
    }
